      ...
      <table class="table table-hover">
        ...
        <tbody class="table-border-bottom-0">
          <tr>
            ...
            <td><input type="text" class="form-control" id="basic-default-fullname" placeholder="John Doe" value="#1989273"></td>
            <td>
                <select class="form-select-cus" id="exampleFormControlSelect1" aria-label="Default select example">
    ...
    <div class="card mb-6">
      <div class="row row-bordered g-0">
        <div class="col-lg-4 p-6">
          ...
          <button type="button" class="btn btn-icon btn-outline-secondary waves-effect" id="addRowBtnBeer">
