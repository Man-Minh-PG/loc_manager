    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-hover">
        ...
        <tbody class="table-border-bottom-0">
          <tr>
            ...
            <td><a target="_blank" href="https://project.lampart-vn.com/issues/{{$lstLocDetail[0]->number_task}}"> {{$lstLocDetail[0]->number_task}} </a></td>
            <td>
            ...
            <td> 
              @if(!is_null($lstLocDetail[0]->run_time))
                {{$lstLocDetail[0]->run_time}}
              @else
                'Updated....'
              @endif
            </td>
      ...
      <table class="table table-hover">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            {{-- <td><i class="ri-suitcase-2-line ri-22px text-danger me-4"></i><span>#191817</span></td> --}}
            <td><a target="_blank" href="https://project.lampart-vn.com/issues/{{$child->number_task}}"> {{$child->number_task}} </a></td>
            <td>
